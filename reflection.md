...
This challenge involved a combination of data filtering, text mining, machine learning, and interpretability. 

The first task: identifying the manipulated book — required computing a custom hash and locating a hidden marker in the reviews dataset. 
This step highlighted how hidden signals can be embedded in large text corpora and how metadata such as rating distributions can reveal anomalies.

The second step focused on extracting the single fake review containing the injected hash value. 
